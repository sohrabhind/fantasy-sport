...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SQLiteHandler db = new SQLiteHandler(CheckoutActivity.this);
        ...
        assert phone != null;
        String newsURL = "http://hindbyte.com/redfun/payment/index.php?phone=" + phone.replace("+", "%2B") + "&amount=" + amount + "&name=" + name;
    ...
    private boolean onKeyCodeBack() {
        if (frameLayout.getChildCount() > 1) {
            frameLayout.removeViewAt(frameLayout.getChildCount()-1);
        } else if (myWebView.canGoBack() && !myWebView.getUrl().equals("http://hindbyte.com/razorpay/verify.php")) {
            myWebView.goBack();
        } else {
            finish();
        }
