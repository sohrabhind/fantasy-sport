...
public class MyTeamsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(MyTeamsActivity.this);
    ...
    private void getTopFeed() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, "http://hindbyte.com/redfun/teams/myteams.php", response -> {
            swipeRefreshLayout.setRefreshing(false);
            try {
