...
public class MyMatchesFragment extends Fragment {
    ...
    public static MyMatchesFragment newInstance() {
        MyMatchesFragment myFragment = new MyMatchesFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(direction -> {
            if (direction == SwipyRefreshLayoutDirection.TOP) {
                getTopFeed();
            } else if (direction == SwipyRefreshLayoutDirection.BOTTOM && !matchList.isEmpty()) {
                getBottomFeed();
            } else {
    ...
    private void getTopFeed() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, "http://hindbyte.com/redfun/matches/mymatches.php", response -> {
            swipeRefreshLayout.setRefreshing(false);
            try {
                matchList.clear();
    ...
    private void getBottomFeed() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, "http://hindbyte.com/redfun/matches/mymatches.php", response -> {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("phone", phone);
                params.put("pass", pass);
                params.put("last_id", matchList.get(matchList.size()-1).getId());
                return params;
            }
        };
        strReq.setShouldCache(false);
